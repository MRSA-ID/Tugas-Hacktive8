      ...
      <div className=" w-9/12 p-10">
        ...
        <ul className="text-3xl text">
          ...
          <li className="bg-gray-550 w-full p-6">
            <button>
              <span>
                <b>How much does Netflix cost?</b>
              </span>
            </button>
            <div className="hidden bg-gray-550">
          ...
          <li className="bg-gray-550 w-full p-6">
            <button>
              <span>
                <b>What can i watch on Netflix?</b>
              </span>
            </button>
            <div className="hidden bg-gray-550">
        ...
        <form className="container pt-2">
          <div className="px-10 h-16 flex mt-6">
            <input
              className="p-4 w-full border border-gray-300 focus:outline-none text-black text-xl"
